...
public class KeyBindings {
    ...
    public static void init() {
        porterNextDestination = new KeyBinding("key.nextDestination", KeyConflictContext.IN_GAME, InputMappings.getInputByName("key.keyboard.right.bracket"), "key.categories.rftools");
        ClientRegistry.registerKeyBinding(porterNextDestination);
        porterPrevDestination = new KeyBinding("key.prevDestination", KeyConflictContext.IN_GAME, InputMappings.getInputByName("key.keyboard.left.bracket"), "key.categories.rftools");
