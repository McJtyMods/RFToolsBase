...
public class DimensionCompositeFeature<F extends IFeatureConfig> extends ConfiguredFeature<F> {

    private final DimensionType dimension;

    public DimensionCompositeFeature(ConfiguredFeature<F> decoratedFeature, @Nonnull DimensionType dimension) {
