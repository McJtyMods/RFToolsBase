...
public interface IProcessor {
     ...
     */
    @Nullable
    List<IParameter> evaluateVectorParameter(ICompiledOpcode compiledOpcode, IProgram program, int parIndex);
     ...
     */
    @Nonnull
    List<IParameter> evaluateVectorParameterNonNull(ICompiledOpcode compiledOpcode, IProgram program, int parIndex);
     ...
     * is relative to how the variables are allocated for the card
     */
    IParameter getVariable(IProgram program, int var);
